...
export class CrvyRprtrVitestReporter implements Reporter {
  ...
  async onBrowserInit(project: TestProject): Promise<void> {
    ...
    console.log(`[CrvyRprtrVitestReporter] Browser project ready: ${project.name || 'browser'}`)
  }

  onTestRunStart(specifications: ReadonlyArray<TestSpecification>): void {
    console.log(`[CrvyRprtrVitestReporter] Starting run with ${specifications.length} test module(s)`)
  }
...
export const CreeveyVitestReporter = CrvyRprtrVitestReporter
